...
if (init) {
  ...
  let initial_tags = ['household chore', 'school', 'hobby', 'important', 'full stack', 'foo'];
  ...
  if (!empty) {
    ...
    db.serialize(() => {
      db.run('INSERT INTO tags (name) VALUES ' + placeholders, initial_tags)
        ...
        .run(`INSERT INTO tasks (name, tags) VALUES ('sleep', '4,6');`)
        .run(`INSERT INTO tasks (name, tags) VALUES ('breathe', '3,6');`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-11-11 16:23:02.000', 1, 0);`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-11-11 16:28:33.542', 1, 1);`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-11-11 20:12:04.823', 1, 0);`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-11-11 21:48:59.002', 1, 1);`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-11-12 00:52:00.999', 1, 0);`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-11-12 01:04:14.000', 1, 1);`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-11-12 06:34:17.000', 1, 0);`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-11-11 13:13:13.345', 2, 0);`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-11-12 04:10:06.917', 2, 1);`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-11-12 14:01:07.427', 2, 0);`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-11-12 16:13:13.555', 2, 1);`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-11-12 19:44:26.231', 2, 0);`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-11-12 21:39:09.111', 2, 1);`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-11-11 21:00:00.000', 3, 0);`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-11-12 10:00:00.000', 3, 1);`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-11-10 21:00:00.000', 4, 0);`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-11-11 10:00:00.000', 4, 1);`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-11-11 21:00:00.000', 4, 0);`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-11-12 10:00:00.000', 4, 1);`)
